...
export const repos: Repo[] = [
  {
    ...
    url: 'https://github.com/PardhuWebDev/indiaquant-mcp',
    language: 'Python',
    tags: ['MCP', 'LLM', 'Finance'],
    featured: true
  },
  {
    ...
    url: 'https://github.com/PardhuWebDev/research-synthesizer',
    language: 'Python',
    tags: ['LangGraph', 'RAG', 'Agents']
  },
  {
    name: 'VELA-Voice-Agent',
    description:
    ...
    >
      ...
      <div className="mt-6 rounded-2xl border border-foreground/5 bg-white p-6 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-sm font-semibold text-foreground">My Resume</h3>
            <p className="mt-0.5 text-xs text-foreground/50">
              Here&apos;s a copy of my latest resume — feel free to download it.
            </p>
          </div>
          <a
            href="/resume/Resume.pdf"
            download="Pardha_Saradhi_Resume.pdf"
            className="flex items-center gap-2 rounded-full bg-foreground px-4 py-2 text-xs font-medium text-background transition-opacity hover:opacity-80"
          >
